...
class Centroid {
 public:
  ...
  Centroid(const Centroid &o) {weight_ = o.weight_; mean_ = o.mean_;}
...
class TDigest {
 ...
 public:
  ...
  Weight getWeight() {
    return weight(processed_);
  }

  Value getSum() {
    return Sum(processed_);
  }
  ...
  TDigest(const TDigest& o)
      : TDigest(o.processed_, o.unprocessed_, o.compression_, o.maxUnprocessed_,
                o.maxProcessed_) {}
